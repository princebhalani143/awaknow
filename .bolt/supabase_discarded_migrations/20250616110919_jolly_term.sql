/*
  # Fix All Subscription and RLS Issues

  This migration addresses all the subscription-related errors:
  1. Fixes RLS policies on user_subscriptions table
  2. Adds service role permissions for system operations
  3. Ensures proper user creation flow
  4. Sets up demo user with correct permissions
*/
